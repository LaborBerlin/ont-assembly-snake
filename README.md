...
```bash
# Install
git clone https://github.com/LaborBerlin/ont-assembly-snake.git
...
```
git clone https://github.com/LaborBerlin/ont-assembly-snake.git /opt/software/ont-assembly-snake
```
...
## Test dataset
A test dataset containing a pair of ONT and Illumina sequencing data from the same bacterial isolate is available in the repository [ont-assembly-snake-testdata](https://github.com/pmenzel/ont-assembly-snake-testdata). See the instructions therein on how to download the dataset and run the ont-assembly-snake and [score-assemblies](https://github.com/LaborBerlin/score-assemblies) workflows.
...
The assemblies generated by this workflow can be evaluated using the [score-assemblies](https://github.com/LaborBerlin/score-assemblies) workflow.
One can either download the score-assemblies repository separately and just run it in the same folder after ont-assembly-snake is done, see the [README](https://github.com/LaborBerlin/score-assemblies/blob/master/README.md) or
add the Snakemake command line parameter `--config run_score_assemblies=1` to the Snakemake call of ont-assembly-snake.

## License

The code is licensed under MIT-License before release v1.5 and GPL 3.0 (or later) from release v1.5.
